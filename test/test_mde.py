...
def test_bcra3f2() -> None:
    result = mde.mde_bcra3f2(rho2=0.10, n=20, J=44, K=5, alpha=0.05)
...
def test_bcra3r2() -> None:
    result = mde.mde_bcra3r2(rho3=0.13, rho2=0.10, omega3=0.4, n=10, J=6, K=24, alpha=0.05)
...
def test_bcra4f3() -> None:
    result = mde.mde_bcra4f3(rho3=0.15, rho2=0.15, n=10, J=4, K=4, L=15, alpha=0.05)
...
def test_bcra4r2() -> None:
    result = mde.mde_bcra4r2(
        rho4=0.05, rho3=0.15, rho2=0.15, omega4=0.50, omega3=0.50, n=10, J=4, K=4, L=20, alpha=0.05
    )
...
def test_bcra4r3() -> None:
    result = mde.mde_bcra4r3(rho4=0.05, rho3=0.15, rho2=0.15, omega4=0.50, n=10, J=4, K=4, L=20, alpha=0.05)
...
def test_bira2r1() -> None:
    result = mde.mde_bira2r1(rho2=0.17, omega2=0.50, n=15, J=20, alpha=0.05)
...
def test_bira3r1() -> None:
    result = mde.mde_bira3r1(rho3=0.20, rho2=0.15, omega3=0.10, omega2=0.10, n=69, J=10, K=100, alpha=0.05)
...
def test_bira4r1() -> None:
    result = mde.mde_bira4r1(
        rho4=0.05, rho3=0.15, rho2=0.15, omega4=0.50, omega3=0.50, omega2=0.50, n=10, J=4, K=4, L=27, alpha=0.05
    )
...
def test_cra2r2() -> None:
    result = mde.mde_cra2r2(rho2=0.17, n=15, J=20, alpha=0.05)
...
def test_cra3r3() -> None:
    result = mde.mde_cra3r3(rho3=0.06, rho2=0.17, n=15, J=3, K=60, alpha=0.05)
